...
$this->title = 'Transporte #'.$transporte;
$this->params['breadcrumbs'][] = $this->title;
?>

<div class="transporte-receber">

    <h1><?= Html::encode($this->title) ?></h1>
    <br>
    <h4 style="font-family: 'Yu Gothic UI Light';"><?= Html::encode('LIVROS A RECEBER') ?></h4>
    <hr>
    ...
    <div class="col-md-12" style="margin-top: 15px; padding-left: 0">
        <div class="">
            <?= Html::a('Receber Transporte', ['transporte/update', 'id' => $transporte], ['class' => 'btn btn-success tratarTransporte']); ?>
        </div>
    </div>
